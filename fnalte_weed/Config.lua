...
Config.Fertilizing  = {
    FertilizingOne  = 'water'                   ,
    FertilizingTwo  = 'fertilizer'              ,
}

Config.WeedPlants   = {
    SeedOne         = {
        Spawn       = 'weed_og-kush_seed'       ,
        Label       = 'Kush Seed'               ,
        Description = 'Used for planting'       ,
        Choice      = '> Brug'                  ,
    },
    SeedTwo         = {
        Spawn       = 'weed_bananakush_seed'    ,
        Label       = 'Bananakush Seed'         ,
        Description = 'Used for planting'       ,
        Choice      = '> Brug'                  ,
    },
    SeedThree       = {
        Spawn       = 'weed_bluedream_seed'     ,
        Label       = 'Bluedream Seed'          ,
        Description = 'Used for planting'       ,
        Choice      = '> Brug'                  ,
    },
    SeedFour        = {
        Spawn       = 'weed_purple-haze_seed'   ,
...
Config.Notifications    = {
    MaxPlantCount       = 'Du har allerede ' .. Config.MaxPlantCount .. ' planter plantet'  ,
    Missing             = 'Du mangler'                                                      ,
    Harvested           = 'Du høstede'                                                      ,
    TooClose            = 'For tæt på en anden plante'                                      ,
    Error               = 'Error'                                                           ,
}
...
Config.Draw3DText       = {
    ...
    Growth              = '- Vækst:',
    Quality             = '- Kvalitet:',
    Feed                = '~b~G~w~ - Vand      ~y~H~w~ - Gøde',
    DoneQuality         = 'Kvalitet:',
    Harvest             = '~g~E~w~ - Høst',
    Search              = '~y~G~w~ - Søg',
}
